...
{
    public class SecurityLoginsRolePocoController : Controller
    {
        private readonly CareerCloudContext _context;

        public SecurityLoginsRolePocoController(CareerCloudContext context)
        {
            _context = context;
        }

        // GET: SecurityLoginsRolePoco
        ...
        // GET: SecurityLoginsRolePoco/Details/5
        ...
        // GET: SecurityLoginsRolePoco/Create
        public IActionResult Create()
        {
            ViewData["Login"] = new SelectList(_context.SecurityLogin, "Id", "Id");
            ViewData["Role"] = new SelectList(_context.SecurityRole, "Id", "Id");
            return View();
        }

        // POST: SecurityLoginsRolePoco/Create
        ...
        public async Task<IActionResult> Create([Bind("Id,Login,Role")] SecurityLoginsRolePoco securityLoginsRolePoco)
        {
            ...
            ViewData["Login"] = new SelectList(_context.SecurityLogin, "Id", "Id", securityLoginsRolePoco.Login);
            ViewData["Role"] = new SelectList(_context.SecurityRole, "Id", "Id", securityLoginsRolePoco.Role);
            return View(securityLoginsRolePoco);
        }

        // GET: SecurityLoginsRolePoco/Edit/5
        ...
        // POST: SecurityLoginsRolePoco/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: SecurityLoginsRolePoco/Delete/5
        ...
        // POST: SecurityLoginsRolePoco/Delete/5
